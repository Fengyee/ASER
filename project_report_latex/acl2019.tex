...
\title{COMP 5222 Project Report}

\author{ZHANG Jingyang \\
  \texttt{Student ID: xxx} \\
  \texttt{xxx@connect.ust.hk} \\\AND
  GAO Shenlai \\
  \texttt{Student ID: xxx} \\
  \texttt{xxx@connect.ust.hk} \\\And
  FENG HAOAN \\
  \texttt{Student ID: 20256227} \\
  \texttt{hfengac@connect.ust.hk} \\}
...
\begin{enumerate}
  \item What problem did you work on? Why is it interesting? \\ xxx
  \item What are the important ideas you explored? \\ xxx
  \item What ideas from the class did you use? \\ xxx
  \item What did you learn? \\ xxx
  \item Summary of results \\ xxx
\end{enumerate}

\section{Related work}
xxx

\section{Methodologies/Approaches you have tried}
xxx
